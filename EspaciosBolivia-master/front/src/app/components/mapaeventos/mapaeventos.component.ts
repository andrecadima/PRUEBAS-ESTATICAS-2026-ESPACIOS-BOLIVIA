...
export class MapaeventosComponent implements OnInit {
  ...
  constructor( private readonly apiService: ApiService, private readonly sanitizer: DomSanitizer, private router: Router, private readonly route: ActivatedRoute) {}
